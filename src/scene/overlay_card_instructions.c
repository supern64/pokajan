...
static void CardInstructionsRender(void *self) {
	...
	// we presume that the correct cards have already been loaded by GameInit
	...
	DrawMainText(step1, (Vector2){ 170, 360 }, 40, WHITE);
	...
	DrawMainText(step3, (Vector2){ 170, 555 }, 40, WHITE);
